...
class FactoryConexion
{
    public static string CreateConnection()
    {
        ...
        {
            if (ConfigurationManager.ConnectionStrings[i].Name.Equals("AppJuegoOlimpico.Properties.Settings.SqlServer", StringComparison.InvariantCultureIgnoreCase))
                existe = true;
        }
        ...
        return ConfigurationManager.ConnectionStrings["AppJuegoOlimpico.Properties.Settings.SqlServer"].ConnectionString;
    }
    public static string CreateConnection(string pUsuario, String pContrasena)
    {
        ...
        conexion.AppendFormat("{0}", ConfigurationManager.ConnectionStrings["slnCapas.Properties.Settings.CadenaSqlServer"].ConnectionString);
        // Agrega al usuario
