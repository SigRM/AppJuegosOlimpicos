                ...
                if (sfd.ShowDialog() == DialogResult.OK)
                {
                    ...
                    if (!fileError)
                    {
                        try
                        {
                            ...
                            MessageBox.Show("File created sucessfully", "Attention");
                        }
                        catch (Exception ex)
                        {
            ...
            using (SaveFileDialog sfd = new SaveFileDialog() { Filter = "PDF files|*.pdf", FileName = "Grid_" + nombreArchivo + ".pdf" })
            {
                if (sfd.ShowDialog() == DialogResult.OK)
                {
                    try
                    {
                        ...
                        doc.Add(table);
                        doc.Close();
                        MessageBox.Show("File created sucessfully", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    catch (Exception ex)
                    {
